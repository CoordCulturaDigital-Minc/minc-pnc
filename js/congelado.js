            ...
            init: function(){
                $('.hl-carrousel').each(function(){
                    ...
                    if ($right.length == 0 && $left.length == 0) {
                        autoscroll = true;
                        // cria um elemento dummy para o autoscroll
                        $wrapper.append('<a class="hl-nav-right" style="display:none"></a>');
                        $right = $wrapper.find('.hl-nav-right');
                    }
                    ...
                    if (autoscroll)
                        setInterval(function() {$right.click()}, 6000);
